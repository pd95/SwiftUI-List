...
<img alt="List using custom background along with size printed for debugging" src="_images/List_row_background_size_macOS11.png" width="400" />  <img alt="List using custom background along with size printed after dragging a row" src="_images/List_row_background_size_after_drag_macOS11.png" width="400" />
